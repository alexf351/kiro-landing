---
title: "Grok 4.5: SpaceXAI's coding model, reviewed honestly"
...
# Grok 4.5: SpaceXAI's coding model, reviewed honestly
...
- It is SpaceXAI's first model built specifically for coding and agentic work, trained using real developer session data rather than general web text.
...
Grok 4.5 is SpaceXAI's coding and agentic model, released on 8 July 2026. It is a mixture-of-experts model trained on real developer session data, priced at $2 per million input tokens and $6 per million output.

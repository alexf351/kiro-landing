...
If you want to build your own AI fluency alongside your students', **Iro AI** teaches practical AI skills in five-minute daily lessons &mdash; prompting, verification, tool selection and where AI fails &mdash; across 34 learning paths and 522 lessons. Every path is open on the free tier, and it runs on iPhone or in any browser. It is built for individual learners aged 13 and up rather than as a classroom management system, so the honest use here is your own practice, or a recommendation to older students who want to go further than a unit allows. Our companion guide on [AI for teachers](/blog/ai-for-teachers) covers using AI for planning, feedback and differentiation &mdash; the other half of this job.

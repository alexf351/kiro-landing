...
Grok is available inside X and via its own app and site; access and limits depend on your plan and whether you have an X subscription. Check the current options, as they change.

**What is Grok good for?**

Grok is good for keeping up with current conversations and trending topics on X, thanks to its real-time access, and for people who prefer a casual tone. For careful, high-stakes work, mainstream assistants like ChatGPT and Claude are often steadier.

...
Iro is the Duolingo for AI — built around exactly this five-minute loop. Each lesson is short and hands-on: you write prompts in a Prompt Lab that gives feedback, evaluate AI answers, and learn one concept at a time across 25 learning paths (433 lessons, 2,050+ exercises) covering ChatGPT, Claude, Gemini, Perplexity, prompt engineering, AI agents, automation, and more.

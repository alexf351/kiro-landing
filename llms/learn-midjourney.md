---
title: "Learn Midjourney: Prompts, Parameters & Style | Iro AI"
canonical_url: "https://tryiro.com/learn-midjourney"
site: "Iro AI"
site_url: "https://tryiro.com"
app_store: "https://apps.apple.com/app/id6759628066"
language: en-US
keywords: ["learn Midjourney", "how to use Midjourney", "Midjourney prompts", "Midjourney parameters", "Midjourney prompt guide", "Midjourney aspect ratio"]
audience: "Designers, marketers, creators, and anyone making images with AI"
...
**Canonical page:** https://tryiro.com/learn-midjourney
...
1. **The four-layer prompt** (5 min) — Subject, style, composition, lighting: the order that turns a sentence into a shot.
2. **Parameters that actually matter** (5 min) — --ar, --stylize, --v, and --no, and when each one changes your result.
3. **Style and lighting on purpose** (6 min) — Name a medium, a mood, and a light source so the model stops guessing for you.
4. **Keep it consistent** (5 min) — Use style references (--sref) and character references (--cref) to hold one look across images.
5. **Iterate, don't restart** (5 min) — Variations, upscales, and remix to steer an almost-right image all the way home.
...
**Scenario:** You type "a cool logo dragon" into Midjourney and get four random, muddy results that look nothing alike and nothing like a logo.

**Task:** Choose the prompt most likely to give you a usable, controllable image.

- "a cool dragon, make it awesome and high quality 4k"
- **(correct)** "minimalist flat vector logo of a coiled dragon, bold single-color silhouette, centered on a white background, clean geometric lines, mascot style --ar 1:1 --style raw --no gradient, shading"
- "dragon logo please, something professional"
- "the best possible dragon logo you can make"

**Why:** The winning prompt works in layers: a clear **subject** (a coiled dragon), a specific **style and medium** (minimalist flat vector logo, mascot style), **composition** (centered, clean geometric lines, white background), and **parameters** that control the output: **--ar 1:1** for a square logo, **--style raw** to cut Midjourney's default flourish, and **--no gradient, shading** as a negative prompt to keep it flat. Phrases like "high quality 4k" and "make it awesome" do nothing, since they're not things the model can act on. In Iro you'd rewrite a weak prompt like this and get feedback on the exact layer you left out.

---
title: "Learn Notion AI: Draft, Summarize & Ask Docs | Iro AI"
canonical_url: "https://tryiro.com/learn-notion-ai"
site: "Iro AI"
site_url: "https://tryiro.com"
app_store: "https://apps.apple.com/app/id6759628066"
language: en-US
keywords: ["learn Notion AI", "how to use Notion AI", "Notion AI prompts", "Notion AI summarize", "Notion AI database autofill", "Notion Q&A"]
audience: "Teams, founders, students, and anyone who runs their life in Notion"
...
**Canonical page:** https://tryiro.com/learn-notion-ai
...
1. **Draft without the blank page** (5 min) — Prompt Notion AI for a first draft, then edit it into your voice right in the doc.
2. **Notes to action items** (5 min) — Turn raw meeting notes into a checklist with owners and due dates you can assign.
3. **Summaries people actually read** (5 min) — Get a tight summary at the top of a long doc, aimed at one specific reader.
4. **AI inside databases** (6 min) — Use AI autofill to categorize, summarize, or extract a field across every row.
5. **Ask your workspace** (5 min) — Use Q&A to find and synthesize answers from your own pages, with links to the sources.
...
**Scenario:** You paste 20 lines of messy meeting notes into a Notion doc and want a clean list of next steps your team can actually act on.

**Task:** Choose the Notion AI prompt that turns the notes into something usable.

- "Summarize these notes."
- **(correct)** "From the notes above, extract every action item as a checklist. For each one, name the owner mentioned and any due date, and mark items with no owner as 'Unassigned'. Ignore general discussion that isn't a decision or a task."
- "Make this look better."
- "What should we do next?"

**Why:** The winning prompt is **grounded in the notes above** and asks for a specific **output format** (a checklist), names the exact **fields to extract** (owner and due date), handles an **edge case** (mark items with no owner as 'Unassigned'), and sets the **scope** (ignore general discussion). "Summarize these notes" gives you a paragraph you still have to read; "what should we do next?" asks the AI to decide for you rather than pull what your team already agreed. In Iro you'd write your own version and get feedback on the fields and edge cases you missed.
